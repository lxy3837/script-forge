...
| 项目列表 | 工作台 |
|----------|--------|
| ![首页](img/01-首页-项目列表.png) | ![工作台](img/02-项目工作台.png) |

| 需求调研 | 大纲选择 |
|----------|----------|
| ![需求调研](img/03-需求调研.png) | ![大纲选择](img/04-大纲选择.png) |

| 剧本阅览 | 审核报告 |
|----------|----------|
| ![剧本阅览](img/05-剧本阅览.png) | ![审核报告](img/06-审核报告.png) |

| 知识库 | 系统配置 |
|--------|----------|
| ![知识库](img/07-知识库管理.png) | ![系统配置](img/08-系统配置.png) |
